...
from core.models import PodcastScript, ScriptStyle, ScriptSegment
...
class AudioGenerator:
        ...
        try:
            ...
            for attempt, fallback_voice in enumerate(voice_fallbacks, 1):
                ...
                if audio_content:
                    ...
                    safe_title = self.pipeline._make_safe_filename(script.source_article_id)
    ...
    def _create_podcast_package(self, script, audio_result: Dict, style: str, voice: str, topic: str) -> Dict:
        ...
        package_info = {
            "success": True,
            "title": f"{script.source_article_id} - {style.title()} Podcast",
            "source_article": script.source_article_id,
            "style": style,
            "voice": voice,
